...
# 哈希表
 ...
 - [x]  332\. **Reconstruct Itinerary (Medium)**
 - [ ]  304\. Range Sum Query 2D - Immutable (Medium)
 - [ ]  560\. Subarray Sum Equals K (Medium)
 - [x]  503\. ~~Next Greater Element II (Medium) Daily Temperature 的变种题。~~
 - [x]  697\.  ~~(Easy) 如何对数组进行预处理才能正确并快速地计算子数组的长度?~~
...
## Backtracking
 ...
 - [x]  2\. ~~Binary Tree Paths (Easy) 输出二叉树中所有从根到叶子的路径，回溯法使用与否有什么区别？进阶难度~~
...
# 字符串
 ...
 - [x]  3\. ~~Longest Substring Without Repeating Characters (Medium) 计算最长无重复子字符串，同样的，可以利用其它数据结构进行辅助统计。~~
...
## 多数投票问题
 - [x]  169\. Majority Element (Easy) 如果想不出简单的解决方法，搜索一下 Boyer-Moore Majority Vote 算法吧。
## 其它
...
## 斐波那契数列
 ...
 - [x]  70\. Climbing Stairs (Easy) 动态规划
 ...
 - [x]  376\. Wiggle Subsequence (Medium) 最长摆动子序列，通项公式比较特殊，需要仔细思考。
## 矩阵路径
...
## 最长公共子序列
 ...
 - [x]  416\. ~~Partition Equal Subset Sum (Medium)~~ 背包问题
 - [x]  494\. **Target Sum (Medium)** 注意排查输入的数据问题
 - [ ]  474\. Ones and Zeroes (Medium)
 - [x]  322\. !**Coin Change (Medium)**
 - [x]  518\. !**Coin Change 2 (Medium)** 本质和爬楼梯是一样的 problem(i) = sum(problem(i-j)), j = 1, 2,  5
